...
def generate_html_report(repos, stats):
    """HTMLレポートを生成"""
        ...
        <div class="two-column">
            <div class="repo-list">
                ...
                <div class="repo-item">
                    ...
                    <div class="repo-meta">
                        作成: {repo.get('createdAt', '').split('T')[0]}
                        {f' - {repo.get("description", "")}' if repo.get('description') else ''}
                    </div>
                </div>
...
def main():
    ...
    # HTMLレポート生成
    html_content = generate_html_report(repos, stats)
